      ...
      <div className='flex flex-col w-full gap-2'>
        <form
          ...
          <img src={linkIcon} alt='link_icon'
            className='absolute left-0 top-1 my-2 ml-3 w-5' />
          ...
          <button
            type='submit'
            className='submit_btn peer-focus:border-gray-700 peer-focustext-gray-700'>
            go
          </button>
        </form> <br />
            ...
            <div key={`link-${index}`} onClick={() => setArticle(item)}
              ...
              <div className='copy_btn' onClick={() => handleCopy(item.url)}>
                <img src={copied === item.url ? tick : copy} alt='copy_icon'
                  className='w-[100%] h-[40%] object-contain px-1' />
              </div>
              <p className='flex- font-satoshi text-blue-800 font-medium text-sm truncate'>
                {item.url}
              </p>
